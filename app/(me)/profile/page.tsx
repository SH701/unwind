    ...
    <div className="flex flex-col h-[calc(100vh-100px)] bg-green-100">
      <div className="flex-1 flex flex-col items-center px-4">
        ...
        <Link href="/profile/secession" className="mt-3 w-full max-w-md">
          <button
            type="button"
            className="w-full btn text-white bg-red-500 hover:bg-red-400"
          >
            회원탈퇴
          </button>
        </Link>
      </div>
      <footer className="border-t px-4 py-6  flex items-center justify-between text-sm text-gray-700 italic">
        <div>
          당신의 이야기를 기록하는 공간,<br />
          <span className="font-semibold not-italic">Unwind.</span>
        </div>
        <a
